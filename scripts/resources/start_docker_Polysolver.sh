...
# The Polysolver Docker contains a folder /home/polysolver with important scripts
# We cannot mount the entire /home directory to the container <-> xHLA
docker run \
$cpuset_param \
--cidfile "$docker_cid" \
--rm \
--entrypoint='' \
-e HOME="$HOME" \
-v /home/arne:/home/arne \
-v /tmp:/tmp \
-v /home/labgroups/ccgg:/home/labgroups/ccgg \
-w "$PWD" \
sachet/polysolver:v4 \
